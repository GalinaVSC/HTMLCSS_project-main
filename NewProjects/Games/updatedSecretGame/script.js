 ...
 * Modified to use circles and x's instead of red and blue 
 * markers by Alex Sensei
 */
$(document).ready(function() {
    ...
    $(".little_table").find("td:not(.filled)").click(function() {
        ...
        // whose turn is it?
        var markerType = $("#turn").hasClass("red") ? "circle" : "x"; // Determine marker type
        ...
        var div = $("<div>")
            .addClass("marker")
            .addClass(markerType) // Add marker type dynamically ("x" or "circle")
            .addClass('col-' + little_col)
            .addClass('row-' + little_row);
        ...
        markers = little_table.find(".marker").filter("." + markerType);
